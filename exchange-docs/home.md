# MuleSoft - Plugin - Error Handler Plugin
...
- [MuleSoft - Plugin - Error Handler Plugin](#mulesoft---plugin---error-handler-plugin)
  ...
  - [Versions](#versions)
    - [Changes from versions previous to 6.0.0](#changes-from-versions-previous-to-600)
  ...
  - [Configuration](#configuration)
    ...
    - [App Preparation](#app-preparation)
      - [Update HTTP Listener Response](#update-http-listener-response)
    - [Error Handler Flow](#error-handler-flow)
    - [Example](#example)
  - [Common Errors Tab](#common-errors-tab)
    - [Use Generated Error Message](#use-generated-error-message)
  - [Custom Errors Tab](#custom-errors-tab)
  ...
  - [Advanced Tab](#advanced-tab)
    ...
    - [Use Previous Error](#use-previous-error)
    - [Response Key Name for Payload](#response-key-name-for-payload)
  - [Error Handling Tips](#error-handling-tips)
    - [Override the Default Error](#override-the-default-error)
    - [Override Non-Standard HTTP Status Code Errors](#override-non-standard-http-status-code-errors)
...
ℹ️ **Set this field to an empty string if you do not want to propagate previous errors.  This is the default value**
